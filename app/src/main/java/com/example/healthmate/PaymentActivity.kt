...
class PaymentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSubmit.setOnClickListener {
            ...
            Log.d("PaymentActivity", "Credit Card Number Valid: ${isValidCreditCard(creditCardNumber)}")
            Log.d("PaymentActivity", "Expiration Valid: ${isValidMonthAndYear(expirationMonth, ExpirationYr)}")
            Log.d("PaymentActivity", "CVV Valid: ${isValidCVV(cvv)}")


            if (isValidCreditCard(creditCardNumber) && isValidMonthAndYear(expirationMonth, ExpirationYr) && isValidCVV(cvv)) {
                ...
                if (patientId.isNullOrEmpty()) {
                    ...
                    updates["payment_status"] = "success" // Replace with your actual field and value
